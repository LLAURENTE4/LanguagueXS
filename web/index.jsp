...
<nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
  <div class="container">
    ...
    <div class="navbar-header page-scroll">
      ...
      <a class="navbar-brand page-scroll" href="#page-top">RATIOVOICES</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li>
          <a class="page-scroll" href="#portfolio">TOUR</a>
        </li>
        <li>
          <a class="page-scroll" href="#about">TESTIMONIOS</a>
        </li>
        <li>
          <a class="page-scroll" href="users?action=validation">INICIAR SESION</a>
        </li>
        <li>
          <a class="page-scroll" href="users?action=new">REGISTRARSE</a>
        </li>
      </ul>
    </div>
    <!-- /.navbar-collapse -->
        ...
        <ul class="timeline">
          <li>
            <div class="timeline-image">
              <img class="img-circle img-responsive" src="img/about/photo.jpg" alt="">
            </div>
          ...
          <li class="timeline-inverted">
            <div class="timeline-image">
              <img class="img-circle img-responsive" src="img/about/gianmarco.jpg" alt="">
            </div>
            <div class="timeline-panel">
              <div class="timeline-heading">
                <h4>GIANMARCO</h4>
                <h4 class="subheading">Solista - Cantante</h4>
              </div>
              <div class="timeline-body">
                <p class="text-muted">"Impresionante, tan pocos pasos y ya estoy coordinando con mi pupilos..."</p>
              </div>
            </div>
          </li>
          <li>
            <div class="timeline-image">
              <img class="img-circle img-responsive" src="img/about/salim.jpg" alt="">
            </div>
            <div class="timeline-panel">
              <div class="timeline-heading">
                <h4>SALIM VERA</h4>
                <h4 class="subheading">Vocalista - Guitarrista de LIBIDO</h4>
              </div>
              <div class="timeline-body">
                <p class="text-muted">"'Lo máximo! En la era digital necesitaba algo como esto. Impresionante"</p>
              </div>
            </div>
          </li>
        </ul>
